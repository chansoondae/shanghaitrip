...
const sections = [
  ...
  },
  {
    emoji: "📋",
    title: "온라인 입국신고서",
    content: "[중국 온라인 입국신고서 작성 가이드]\n\n2025년 11월 26일부터 중국에 입국하는 모든 외국인 여행객은 온라인 입국신고서를 의무적으로 작성해야 합니다.\n\n⚠️ 미작성 시 중국 입국이 불가합니다.\n\n■ 입국 시 제출 방법\n1) 작성 후 생성된 QR코드 캡쳐 또는 PDF 파일로 저장\n2) 생성된 QR코드는 이메일 발송 및 스캔 가능 (프린트하는 경우 인식 불가될 수 있음)\n\n★★ 한국 출국 전 QR 코드 저장 필수 ★★\n\n■ 작성 시점\n입국일을 포함하여 입국 90일 이내 작성 가능\n(EX. 12월 20일 중국 입국 시 9월 20일 ~ 12월 20일 이내 작성 가능)",
  },
  {
    emoji: "💴",
    title: "환전",
  ...
  },
  {
    emoji: "👕",
    title: "옷차림",
    content: "8월 상하이는 무덥고 습한 날씨입니다. 낮에는 32~35°C까지 올라갈 수 있으며 자외선이 강합니다. 가볍고 통기성 좋은 옷차림을 권장하며, 선크림과 선글라스를 꼭 챙기세요. 미술관 내부는 냉방이 강할 수 있으니 얇은 겉옷 하나 준비하시면 좋습니다. 편한 신발 필수입니다.",
  },
  {
    emoji: "🍽️",
    title: "식사",
          ...
          <div key={s.title} className="bg-white rounded-2xl p-4 shadow-sm border border-neutral-100 space-y-2">
            ...
            {s.title === "온라인 입국신고서" && (
              <div className="flex flex-col gap-1.5 pt-1">
                <a
                  href="https://s.nia.gov.cn/ArrivalCardFillingPC/entry-registation-home"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs text-blue-500 underline block break-all"
                >
                  ■ 작성 사이트 (중국 이민관리국) →
                </a>
                <a
                  href="https://drive.google.com/file/d/11CJGQv6-mwlRU0BUtvo3Cwn0Ak497qa2/view"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs text-blue-500 underline block break-all"
                >
