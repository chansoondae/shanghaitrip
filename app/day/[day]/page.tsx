...
const dayData: Record<number, {
  ...
  3: {
    ...
    summary: "08:30 호텔 출발 → 쑤저우 박물관 (I.M. Pei) → 쑤저우 현지식 → 쑤저우 현대미술관 (피카소) → 초강남 사천요리 → EKA",
    breakfast: "호텔식",
    lunch: "쑤저우 현지식 (포함)",
    dinner: "초강남 사천요리 (포함)",
    accommodation: HOTEL_NAME,
